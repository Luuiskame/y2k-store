...
const WhatsAppButton = ({
  ...
  const lines = [
    "Hola, quiero confirmar una compra de Y2K Fit Honduras.",
    itemCount ? `Tengo ${itemCount} ${itemCount === 1 ? "artículo" : "artículos"} en el carrito.` : "",
  ...
  return (
    <a
      ...
      className={
        "flex items-center justify-center gap-x-2 rounded-rounded px-5 py-3 font-medium transition-all duration-200 ease-in " +
        (className ?? "")
      }
      style={{
    ...
    >
      ...
      <span className="text-sm">Confirmar por WhatsApp</span>
    </a>
  )
}
