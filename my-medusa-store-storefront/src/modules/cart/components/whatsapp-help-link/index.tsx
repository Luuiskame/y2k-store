...
const WhatsAppHelpLink = ({
  ...
  const lines = [
    "Hola, tengo una duda sobre mi compra en Y2K Fit Honduras.",
    itemCount
      ? `Tengo ${itemCount} ${itemCount === 1 ? "artículo" : "artículos"} en el carrito.`
      : "",
  ...
  return (
    <a
      ...
      data-testid="whatsapp-help-link"
      className="inline-flex items-center justify-center gap-x-1.5 text-xs font-body text-center self-center underline-offset-2 hover:underline transition-opacity hover:opacity-100"
      style={{ color: "var(--brand-silver-ash)", opacity: 0.85 }}
    >
      <svg
        width="13"
        height="13"
